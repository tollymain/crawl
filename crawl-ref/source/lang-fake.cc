...
// 	{"",""},
	...
	{"fungus","algae"},
    {"^bush$","kelp"},
    {"toadstool","underwater toadstool"},
    {"^plant$","fern"},
    {"briar patch","sentient kelp"},
    {" axe$","cleaving claw"},
    {"battleaxe","battle cleaving claw"},
    {"^sword","slashy claw"},
    {"dagger","stabby claw"},
    {"^trident","claw"},
    ...
    {"eyeball","eyestalk"},
    {"eyes","eyestalks"},
    {"frost giant","frost lobsterman"},
    {"hill giant","hiil lobsterman"},
    {"cyclops","one-eyed lobsterman"},
    {"stone giant","stone lobsterman"},
    {"iron giant","iron lobsterman"},
    {"juggernaut","lobstersmash"},
    {"titan","divine lobsterman"},
	// uniques
    {"fannar","icy crabman"},
    ...
    {"khufu","pharaoh crabman"},
    {"mara","illusocrab the great"},
    {"maurice","stealy crabman"},
    {"menkaure","mummy crabman"},
    {"mennas","use tport"},
    {"natasha","kitty crablady"},
    {"nessos","hex-vulnerable crabman"},
    {"nikola","sparky crabman"},
    {"pikel","crabbold slavercrab"},
    {"psyche","crazy old crab-lady"},
    {"robin","crablin"},
    {"roxanne","roxanne-crab"},
    {"rupert","he mad crab"},
    ...
    {"serpent","killer whale"},
    {"tiamat","rainbow crab lady"},
    {"arachne","poison crab lady"},
    {"polymephus","lobstermephus"},
    {"Antaeus","icy mclobsterman"},
	// specific in-game renames
    {"zot","sebastian"},
    {"unarmed","crab-fu"},
	// dieties
 	{"^shining one","shiny crab"},
    {"ashenzari","crabenzari"},
 	{"beogh","shrimp jesus"},
 	{"cheibriados","cool crab luke"},
 	{"dithmenos","dis shadow crab"},
	{"hepliaklqana","ghost crab dad"},
    {"fedhas","fedcrab"},
    {"gozag","goldencrab"},
    {"jiyva","jellycrab"},
    {"kikubaaqudgha","kikacrabalotta"},
    {"lugono","ugocrab"},
    {"makhleb","crableg"},
	{"okawaru","grampa crab"},
    {"nemelex","tapacrab"},
    {"qazlal","crabboom"},
    {"^ru$","ru the arthropodic god of awakened crab seers"},
    {"sif muna","crab mana"},
    {"^trog","trog but a crab"},
    {"uskayaw","uscrabsyall"},
    {"vehumet","crabumet"},
    {"wu jian","crabfu masters"},
	{"xom","still xom"},
	{"yredelemnul","yredlobster"},
	{"^zin$","the reverend crab"},
	// specific messages
