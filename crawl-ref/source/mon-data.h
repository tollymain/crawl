...
{ // not an actual monster, used by a spell
    ...
    M_NO_POLY_TO | M_STATIONARY | M_CONJURED | M_FLIES,
    mrd(MR_RES_POISON, 3) | mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
    0, MONS_SINGULARITY, MONS_SINGULARITY, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 50000, // Invincible in monster::hurt
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_SINGULARITY, TVARY_RANDOM}, TILE_ERROR
},
